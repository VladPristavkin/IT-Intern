...
using ParsingService.Domain.Entities.Exceptions;
...
namespace ParsingService.API.MIddlewares
{
    public class InitializeDatabaseMiddleware
    {
        ...
        public InitializeDatabaseMiddleware(IConfiguration configuration)
        {
